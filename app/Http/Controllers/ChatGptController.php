...
class ChatGptController extends Controller
{
    ...
    public function observe_chatGPT($out_data, $id, $api_key)
    {
        ...
        $message = array();
        $message["role"] = "system";
        $message["content"] = "I am an investor, and you are the expert advising me.\"
